...
namespace Academy.Utilities
{
    ...
    public static class TypeMerger
    {
        ...
        public static TypeMergerPolicy Ignore(Expression<Func<object>> ignoreProperty, Func<bool> predicate = null)
        {
            return new TypeMergerPolicy().Ignore(ignoreProperty, predicate);
        }
        ...
        /// <returns>TypeMerger policy used in method chaining.</returns>
        public static TypeMergerPolicy Use(Expression<Func<object>> useProperty, Func<bool> predicate = null)
        {
            return new TypeMergerPolicy().Use(useProperty, predicate);
        }
    ...
    public class TypeMergerPolicy
    {
        ...
        /// <param name="ignoreProperty">The property of the object to be ignored as a Func.</param>
        /// <returns>TypeMerger policy used in method chaining.</returns>
        public TypeMergerPolicy Ignore(Expression<Func<object>> ignoreProperty, Func<bool> predicate = null)
        {
        ...
        /// <param name="useProperty"></param>
        /// <returns>TypeMerger policy used in method chaining.</returns>
        public TypeMergerPolicy Use(Expression<Func<object>> useProperty, Func<bool> predicate = null)
        {
            if (predicate == null || predicate())
